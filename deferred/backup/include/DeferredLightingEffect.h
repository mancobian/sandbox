...
{		
	...
	public:
		...
		static const std::string GBUFFER_MATERIAL_NAME;
		static const std::string GBUFFER_SCHEME_NAME;
		static const std::string GBUFFER_TECHNIQUE_NAME;
		static const std::string GBUFFER_PASS_NAME;
		static const std::string FRONTFACE_TECHNIQUE_NAME;
		static const std::string BACKFACE_TECHNIQUE_NAME;
		static const std::string TEST_COMPOSITOR_NAME;
		static const std::string LIGHTING_PASS_NAME;
	...
	public:
		inline bool IsEnabled() const { if (this->_compositor_instance) return this->_compositor_instance->getEnabled(); return NULL; }
